...
\begin{document}
    ...
    \section{Conclusiones}
        ...
        \subsection{Erika Martínez Meneses}
            Con esta actividad podemos comprender mejor como se describe un agente, los tipos de agentes y de ambientes que hay y entender mejor qué es la inteligencia artificial y darnos cuenta que puede presentarse en actividades que realizamos en nuestra vida diaria.
