        ...
        \subsection{Realización de una rutina de piso de gimnasia}
            ...
            \subsubsection{Entorno}
                \begin{enumerate}
                    ...
                    \item El ambiente es secuencial debido a que las acciones que realice el agente influyen en sus acciones futuras ya que es una rutina en donde cada parte complementa a la siguiente y una vez realizada la secuencia de movimientos ya no la volverá a repetir del mismo modo en la rutina.
                    ...
                    \item El ambiente puede ser competitivo o cooperativo debido a que si es una competencia de gimnasia contra otros agentes sería competitivo pero si no está compitiendo con otros agentes si no que está presentando su rutina junto con otros agentes se convertiría en cooperativo pero para que sea alguna de estas dos necesitaría ser multiagente.
                \end{enumerate}
        ...
        \subsection{La puja de un artículo de subasta}
            ...
            \subsubsection{Entorno}
                \begin{enumerate}
                    ...
                    \item El ambiente en el que se encuentra el agente es competitivo, ya que en este caso el mejor postor con la mejor oferta se lleva el artículo subastado.
